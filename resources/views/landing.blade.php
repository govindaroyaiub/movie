...
<a class="trailer-video" href="https://youtube.com/embed/eVVHmw3uH2Q?autoplay=1&mute=1">Open Trailer</a>
...
<div id="app">
    ...
    <div class="desktop-nav">
        <div class="tab-wrapper">
            <div class="tab">
                <button class="tablinks" onclick="openItem(event, 'getTickets')"
                        id="defaultOpen">@lang('home.get_tickets')</button>
