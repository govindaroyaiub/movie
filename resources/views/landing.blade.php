...
<div class="mobile-nav">
    <nav role="mobile-menu">
        <div class="menu-toggle">
            ...
            <span></span>
            <ul class="menu">
                <button class="tablinks mobile-link" onclick="openItem(event, 'getTickets')" id="defaultOpen">Go To Cinema</button>
...
<div class="desktop-nav">
    <div class="tab-wrapper">
        <div class="tab">
            <button class="tablinks" onclick="openItem(event, 'getTickets')" id="defaultOpen">Go To Cinema</button>
